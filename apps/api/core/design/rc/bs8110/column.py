...
from core.design.rc.bs8110.formulas import calculate_axial_bending_capacity, calculate_vc, check_shear_stress
...
def calculate_column_reinforcement(
    ...
    if is_biaxial_required:
        from core.design.rc.bs8110.formulas import calculate_biaxial_beta
        # N / (b*h*fcu)
