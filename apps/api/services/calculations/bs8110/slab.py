...
from services.calculations.common.select_reinforcement import select_slab_reinforcement
...
TABLE_3_12 = {
    ...
    ("moment", "near_middle_end_span"):      {"simple": 0.086,  "continuous": 0.086},
...
def design_two_way_slab(
    ...
    notes.append(
        ...
        f"Extend {lx/5:.0f} mm from each corner in both directions, top and bottom."
    )
...
def calculate_slab_reinforcement(
    ...
    if section.slab_type == "one-way":
        ...
        return design_one_way_slab(section, _F)
    else:
