...
def test_rectangular_beam_singly_reinforced():
    section = BeamSection(
        b=230, h=543, cover=25, fcu=28, fy=410, fyv=250,
...
#     section = BeamSection(
#         b=200, h=400, cover=25, fcu=30, fy=460, fyv=250,
#         section_type="rectangular", support_condition="simple"
#     )
...
def main():
    test_rectangular_beam_singly_reinforced()
